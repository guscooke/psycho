<template>
  <div id="app">
    <form class="vue-form mb-6 mr-3" @submit.prevent="submit">
...
<!-- 
        ...
        <div>
          <label class="label" for="textarea">Deixe sua Mensagem</label>
          <textarea
            class="message"
            name="textarea"
            id="textarea"
...
.vue-form {
  ...
  -webkit-box-shadow: 0 5px 3px rgba(0, 0, 0, 0.12),
